...
$lang['form_validation_alpha_numeric_spaces'] =
	'El campo "{field}" solo puede contener caracteres alfanuméricos y espacios.';
$lang['form_validation_alpha_dash'] =
	'El campo "{field}" solo puede contener caracteres alfanuméricos, guiones bajos y guiones.';
...
$lang['form_validation_is_natural_no_zero'] =
	'El campo "{field}" solo puede contener dígitos y debe ser mayor que cero.';
...
$lang['form_validation_error_message_not_set'] =
	'No se ha podido acceder al mensaje de error correspondiente para el campo "{field}".';
$lang['form_validation_in_list'] = 'El campo "{field}" debe contener uno de estos: {param}.';

// Mensajes personalizados
$lang['form_validation_is_unique'] = 'Ya existe el valor especificado en el campo "{field}".';
$lang['form_validation_fechaFormatoValido'] = 'El campo "{field}" no es una fecha válida.';
$lang['form_validation_fechaValidaNoMenorActual'] = 'El campo "{field}" es una fecha no válida o es menor a la actual.';
$lang['form_validation_fechaHoraValidaNoMenorActual'] =
	'El campo "{field}" es una fecha no válida o es menor a la actual.';
$lang['form_validation_fechaValidaNoMayorActual'] = 'El campo "{field}" es una fecha no válida o es mayor a la actual.';
$lang['form_validation_horaFormatoValido'] = 'El campo "{field}" no es una hora válida.';
$lang['form_validation_tamanioMinimoArreglo'] = 'El campo "{field}" debe tener al menos {param} elemento(s).';
$lang['form_validation_tamanioMaximoArreglo'] = 'El campo "{field}" no puede tener más de {param} elemento(s).';
$lang['form_validation_md5Valido'] = 'El campo "{field}" no es MD5.';
$lang['form_validation_emailValido'] = 'El campo "{field}" no es un email válido.';
